...
You can inspect `after_stat()` and `after_scale()` contexts, but there's a twist.
...
What's funny about this is that if you add a legend to the plot, `after_scale()` is evaluated twice. 
